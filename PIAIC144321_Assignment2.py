...
def function8():
    ...
    x = np.full((2,5), dtype=np.float64, fill_value=2.5)#write your code here
...
def function9():
    ...
    a = [x for x in range(1, 101) if x%2 == 0]# write your code here
...
def function12():
    ...
    b=np.vstack((arr,arr,arr))
    c=b.T.reshape(-1)
    ans = np.hstack((c,a))#write your code here 
...
def function13():
    ...
    ans = arr[(5<arr) & (arr<10)]#write your code here 
...
def function14():
    ...
    ans =np.split(a, 4, axis=0) #write your code here 
...
def function19():
    ...
    #Convert "X" variable d  dimension into 5 rows and 5 columns
    #Create one more variable "W" copy of "X" 
    #Swap "W" row and column axis (like transpose)
    # then create variable "b" with value equal to 5
    # Now return output as "(X*W)+b:

    X =  np.arange(1,26).reshape((5,2)) # Write your code here
    W =  W =  np.copy(X).swapaxes(1,0)# Write your code here
